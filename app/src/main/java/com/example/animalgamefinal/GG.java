...
public class GG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.gg);
        a1 = findViewById(R.id.gg1);
        a2 = findViewById(R.id.gg2);
        no = findViewById(R.id.noGG);
        no2 = findViewById(R.id.no2GG);
        yes = findViewById(R.id.yesGG);
        yes2 = findViewById(R.id.yes2GG);
        apple = findViewById(R.id.gitara);
        start = findViewById(R.id.startGG);
