...
public class J extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.j);
        a1 = findViewById(R.id.j1);
        a2 = findViewById(R.id.j2);
        no = findViewById(R.id.noJ);
        no2 = findViewById(R.id.no2J);
        yes = findViewById(R.id.yesJ);
        yes2 = findViewById(R.id.yes2J);
        apple = findViewById(R.id.josta);
        start = findViewById(R.id.startJ);
