...
public class E extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.e);
        a1 = findViewById(R.id.e1);
        a2 = findViewById(R.id.e2);
        no = findViewById(R.id.noE);
        no2 = findViewById(R.id.no2E);
        yes = findViewById(R.id.yesE);
        yes2 = findViewById(R.id.yes2E);
        apple = findViewById(R.id.ezis);
