...
public class H extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1 = findViewById(R.id.h1);
        a2 = findViewById(R.id.h2);
        no = findViewById(R.id.noH);
        no2 = findViewById(R.id.no2H);
        yes = findViewById(R.id.yesH);
        yes2 = findViewById(R.id.yes2H);
        apple = findViewById(R.id.helicopters);
        start = findViewById(R.id.startH);
