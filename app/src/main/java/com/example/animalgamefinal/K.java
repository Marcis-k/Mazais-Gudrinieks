...
public class K extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.k);
        a1 = findViewById(R.id.k1);
        a2 = findViewById(R.id.k2);
        no = findViewById(R.id.noK);
        no2 = findViewById(R.id.no2K);
        yes = findViewById(R.id.yesK);
        yes2 = findViewById(R.id.yes2K);
        apple = findViewById(R.id.kakis);
