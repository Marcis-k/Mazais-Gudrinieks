...
public class LL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1 = findViewById(R.id.ll1);
        a2 = findViewById(R.id.ll2);
        no = findViewById(R.id.noLL);
        no2 = findViewById(R.id.no2LL);
        yes = findViewById(R.id.yesLL);
        yes2 = findViewById(R.id.yes2LL);
        apple = findViewById(R.id.lipa);
        start = findViewById(R.id.startLL);
