...
public class S extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.s);
        a1 = findViewById(R.id.s1);
        a2 = findViewById(R.id.s2);
        no = findViewById(R.id.noS);
        no2 = findViewById(R.id.no2S);
        yes = findViewById(R.id.yesS);
        yes2 = findViewById(R.id.yes2S);
        apple = findViewById(R.id.saule);
