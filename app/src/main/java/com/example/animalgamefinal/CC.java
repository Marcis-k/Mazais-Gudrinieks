...
public class CC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1 = findViewById(R.id.cc1);
        a2 = findViewById(R.id.cc2);
        no = findViewById(R.id.noCC);
        no2 = findViewById(R.id.no2CC);
        yes = findViewById(R.id.yesCC);
        yes2 = findViewById(R.id.yes2CC);
        apple = findViewById(R.id.cibas);
        start = findViewById(R.id.startCC);
