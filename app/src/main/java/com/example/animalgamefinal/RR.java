...
public class RR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.r);
        a1 = findViewById(R.id.r1);
        a2 = findViewById(R.id.r2);
        no = findViewById(R.id.noR);
        no2 = findViewById(R.id.no2R);
        yes = findViewById(R.id.yesR);
        yes2 = findViewById(R.id.yes2R);
        apple = findViewById(R.id.rieksti);
        start = findViewById(R.id.startR);
