...
public class P extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1 = findViewById(R.id.p1);
        a2 = findViewById(R.id.p2);
        no = findViewById(R.id.noP);
        no2 = findViewById(R.id.no2P);
        yes = findViewById(R.id.yesP);
        yes2 = findViewById(R.id.yes2P);
        apple = findViewById(R.id.pile);
        start = findViewById(R.id.startP);
