...
public class EE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.ee);
        a1 = findViewById(R.id.ee1);
        a2 = findViewById(R.id.ee2);
        no = findViewById(R.id.noEE);
        no2 = findViewById(R.id.no2EE);
        yes = findViewById(R.id.yesEE);
        yes2 = findViewById(R.id.yes2EE);
        apple = findViewById(R.id.ezelis);
        start = findViewById(R.id.startEE);
