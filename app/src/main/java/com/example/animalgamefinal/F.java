...
public class F extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.f);
        a1 = findViewById(R.id.f1);
        a2 = findViewById(R.id.f2);
        no = findViewById(R.id.noF);
        no2 = findViewById(R.id.no2F);
        yes = findViewById(R.id.yesF);
        yes2 = findViewById(R.id.yes2F);
        apple = findViewById(R.id.foto);
