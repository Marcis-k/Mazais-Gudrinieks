...
public class L extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.l);
        a1 = findViewById(R.id.l1);
        a2 = findViewById(R.id.l2);
        no = findViewById(R.id.noL);
        no2 = findViewById(R.id.no2L);
        yes = findViewById(R.id.yesL);
        yes2 = findViewById(R.id.yes2L);
        apple = findViewById(R.id.lacis);
        start = findViewById(R.id.startL);
