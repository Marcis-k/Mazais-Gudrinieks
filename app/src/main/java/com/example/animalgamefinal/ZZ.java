...
public class ZZ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.zz);
        a1 = findViewById(R.id.zz1);
        a2 = findViewById(R.id.zz2);
        no = findViewById(R.id.noZZ);
        no2 = findViewById(R.id.no2ZZ);
        yes = findViewById(R.id.yesZZ);
        yes2 = findViewById(R.id.yes2ZZ);
        apple = findViewById(R.id.zirafe);
        start = findViewById(R.id.startZZ);
