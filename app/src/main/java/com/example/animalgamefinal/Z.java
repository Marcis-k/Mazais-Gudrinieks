...
public class Z extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); //To remove top bar and make full screen
        ...
        a = findViewById(R.id.z);
        a1 = findViewById(R.id.z1);
        a2 = findViewById(R.id.z2);
        no = findViewById(R.id.noZ);
        no2 = findViewById(R.id.no2Z);
        yes = findViewById(R.id.yesZ);
        yes2 = findViewById(R.id.yes2Z);
        apple = findViewById(R.id.zebra);
        start = findViewById(R.id.startZ);
