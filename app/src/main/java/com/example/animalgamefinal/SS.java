...
public class SS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.ss);
        a1 = findViewById(R.id.ss1);
        a2 = findViewById(R.id.ss2);
        no = findViewById(R.id.noSS);
        no2 = findViewById(R.id.no2SS);
        yes = findViewById(R.id.yesSS);
        yes2 = findViewById(R.id.yes2SS);
        apple = findViewById(R.id.supoles);
        start = findViewById(R.id.startSS);
