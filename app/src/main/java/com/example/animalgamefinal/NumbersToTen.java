...
public class NumbersToTen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numbers_to_ten);

        no10 = findViewById(R.id.no10);
        no210 = findViewById(R.id.no210);
        yes10 = findViewById(R.id.yes10);
        yes210 = findViewById(R.id.yes210);
