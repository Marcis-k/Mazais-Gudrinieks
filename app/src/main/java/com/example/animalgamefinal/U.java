...
public class U extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.u);
        a1 = findViewById(R.id.u1);
        a2 = findViewById(R.id.u2);
        no = findViewById(R.id.noU);
        no2 = findViewById(R.id.no2U);
        yes = findViewById(R.id.yesU);
        yes2 = findViewById(R.id.yes2U);
        apple = findViewById(R.id.ugunsskurs);
        start = findViewById(R.id.startU);
