...
public class UU extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.uu);
        a1 = findViewById(R.id.uu1);
        a2 = findViewById(R.id.uu2);
        no = findViewById(R.id.noUU);
        no2 = findViewById(R.id.no2UU);
        yes = findViewById(R.id.yesUU);
        yes2 = findViewById(R.id.yes2UU);
        apple = findViewById(R.id.udens);
        start = findViewById(R.id.startUU);
