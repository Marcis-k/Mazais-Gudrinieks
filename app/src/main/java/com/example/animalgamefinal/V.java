...
public class V extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a2 = findViewById(R.id.v2);
        no = findViewById(R.id.noV);
        no2 = findViewById(R.id.no2V);
        yes = findViewById(R.id.yesV);
        yes2 = findViewById(R.id.yes2V);
        apple = findViewById(R.id.vavere);
        start = findViewById(R.id.startV);
