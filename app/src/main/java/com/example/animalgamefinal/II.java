...
public class II extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.ii);
        a1 = findViewById(R.id.ii1);
        a2 = findViewById(R.id.ii2);
        no = findViewById(R.id.noII);
        no2 = findViewById(R.id.no2II);
        yes = findViewById(R.id.yesII);
        yes2 = findViewById(R.id.yes2II);
        apple = findViewById(R.id.ikskis);
        start = findViewById(R.id.startII);
