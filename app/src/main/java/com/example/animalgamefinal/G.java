...
public class G extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        no = findViewById(R.id.noG);
        no2 = findViewById(R.id.no2G);
        yes = findViewById(R.id.yesG);
        yes2 = findViewById(R.id.yes2G);
        apple = findViewById(R.id.gulta);
        start = findViewById(R.id.startG);
