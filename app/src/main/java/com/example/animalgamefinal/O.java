...
public class O extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.o);
        a1 = findViewById(R.id.o1);
        a2 = findViewById(R.id.o2);
        no = findViewById(R.id.noO);
        no2 = findViewById(R.id.no2O);
        yes = findViewById(R.id.yesO);
        yes2 = findViewById(R.id.yes2O);
        apple = findViewById(R.id.ola);
        start = findViewById(R.id.startO);
