...
public class M extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1 = findViewById(R.id.m1);
        a2 = findViewById(R.id.m2);
        no = findViewById(R.id.noM);
        no2 = findViewById(R.id.no2M);
        yes = findViewById(R.id.yesM);
        yes2 = findViewById(R.id.yes2M);
        apple = findViewById(R.id.meduza);
        start = findViewById(R.id.startM);
