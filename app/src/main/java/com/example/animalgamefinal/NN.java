...
public class NN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.nn);
        a1 = findViewById(R.id.nn1);
        a2 = findViewById(R.id.nn2);
        no = findViewById(R.id.noNN);
        no2 = findViewById(R.id.no2NN);
        yes = findViewById(R.id.yesNN);
        yes2 = findViewById(R.id.yes2NN);
        apple = findViewById(R.id.nau);
        start = findViewById(R.id.startNN);
