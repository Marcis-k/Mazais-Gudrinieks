...
public class KK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = findViewById(R.id.kk);
        a1 = findViewById(R.id.kk1);
        a2 = findViewById(R.id.kk2);
        no = findViewById(R.id.noKK);
        no2 = findViewById(R.id.no2KK);
        yes = findViewById(R.id.yesKK);
        yes2 = findViewById(R.id.yes2KK);
        apple = findViewById(R.id.kerra);
        start = findViewById(R.id.startKK);
